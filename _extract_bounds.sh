...
LOG_FILE="./logs/00_extract_bounds.log"
...
# Redirect all stdout and stderr to log file from this point on
mkdir -p "$(dirname "$LOG_FILE")"
exec > "$LOG_FILE" 2>&1

echo "============================================"
echo " STL Bounding Box Extractor v4 - Silent"
echo " Started : $(date)"
echo "============================================"
echo ""
